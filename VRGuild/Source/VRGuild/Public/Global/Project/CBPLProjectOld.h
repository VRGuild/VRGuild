...
#include "CBPLProjectOld.generated.h"
...
//};
//
//// Paged Project List Response Structure (Basic version)
//USTRUCT(BlueprintType)
 ...
 */
UCLASS()
class VRGUILD_API UCBPLProjectOld : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
