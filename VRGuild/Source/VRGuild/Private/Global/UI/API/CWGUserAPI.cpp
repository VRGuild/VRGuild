...
void UCWGUserAPI::OnSuccessAPI(FHttpRequestPtr req, FHttpResponsePtr res)
{
...
void UCWGUserAPI::OnFailAPI(FHttpRequestPtr req, FHttpResponsePtr res)
{
...
void UCWGUserAPI::UserOwnInfoGetCall()
{
    this->API = FString::Printf(TEXT("api/user/epic"));
    HttpGetCall();
}

void UCWGUserAPI::UserOwnInfoGetCallBack(FHttpRequestPtr req, FHttpResponsePtr res)
{
...
void UCWGUserAPI::UserInfoGetCall(const FString& UserId)
{
    this->API = FString::Printf(TEXT("api/user/%s"), *UserId);
    HttpGetCall();
}

void UCWGUserAPI::UserInfoGetCallBack(FHttpRequestPtr req, FHttpResponsePtr res)
{
    FString JsonString = res->GetContentAsString();
    FUserInfoResponse ParsedResponse = JsonPerse<FUserInfoResponse>(JsonString);
...
void UCWGUserAPI::UserMemberInfoGetCall(const FString& UserId)
{
    this->API = FString::Printf(TEXT("api/user/%s/member"), *UserId);
    HttpGetCall();
}

void UCWGUserAPI::UserMemberInfoGetCallBack(FHttpRequestPtr req, FHttpResponsePtr res)
{
    FString JsonString = res->GetContentAsString();
